...
<body>
  ...
  <div>
    ...
    <ul>
<li>
  <b><span style="color:rgb(2, 48, 71);">Job Market Paper:</span> 
  Climate Change, Income Inequality, and Migration in a Spatial Economy</b>
  <p style="margin-top: 2px; margin-bottom: 16px;">
